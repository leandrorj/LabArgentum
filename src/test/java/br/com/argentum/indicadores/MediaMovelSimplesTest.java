...
import br.com.argentum.modelo.GeradorDeSerie;
...
public class MediaMovelSimplesTest {
	...
	public void sequenciaSimplesDeCandles() {
		...
		Assert.assertEquals(10/3, mms.calcula(4, serie), 0.000001);
		Assert.assertEquals(10/3, mms.calcula(5, serie), 0.000001);
		Assert.assertEquals(11.0/3, mms.calcula(6, serie), 0.000001);
